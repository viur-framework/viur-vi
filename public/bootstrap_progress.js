...
function __pygwt_earlyUser() {
    ...
    splash.style = function() {
        ...
        splash.cont.className = "splash cont";
        splash.infoCont.className = "splash infoCont";
        splash.header.className = "splash header";
        ...
        */
        splash.progressBar.className = "splash progressBar";
        splash.status.className = "splash status";
    }
