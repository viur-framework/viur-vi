...
class SaveContinue(Button):
	def __init__(self, *args, **kwargs):
		super( SaveContinue, self ).__init__( translate("Save-Continue"), icon="icon-save-file")
...
class SaveSingleton(Button):
	def __init__(self, *args, **kwargs):
		super(SaveSingleton, self).__init__(translate("Save"), icon="icon-save-file")
...
class ExecuteSingleton(Button):
	def __init__(self, *args, **kwargs):
		super(ExecuteSingleton, self).__init__(translate("Execute"), icon="icon-save-file")
		self["class"] = "bar-item btn btn--small btn--primary btn--save-close"
...
class SaveClose(Button):
	def __init__(self, *args, **kwargs):
		super( SaveClose, self ).__init__( translate("Save-Close"), icon="icon-save-file")
		self["class"] = "bar-item btn btn--small btn--primary btn--save-close"
...
class Refresh(Button):
	def __init__(self, *args, **kwargs):
		super(Refresh, self).__init__(translate("Reload"), icon="icon-reload")
...
class CancelClose(Button):
	def __init__(self, *args, **kwargs):
		super( CancelClose, self ).__init__( translate("Cancel"), icon="icon-save-file")
